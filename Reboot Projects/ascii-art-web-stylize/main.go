...
func path(w http.ResponseWriter, r *http.Request) {
	if r.URL.Path != "/ascii-art" && r.URL.Path != "/" && r.URL.Path != "?:" && r.URL.Path != "400" {
		...
		text.ExecuteTemplate(w, "404.html", nil)
		return
	}
	...
	if err != nil {
		...
		text.ExecuteTemplate(w, "500.html", nil)
		return
	}
	err = t.Execute(w, nil)
	if err != nil {
...
func Handler(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == http.MethodPost {
		...
		err := r.ParseForm()
		if err != nil {
			text.ExecuteTemplate(w, "400.html", nil)
			return
		}
...
func main() {
	...
	var err error
	text, err = template.ParseFiles("templates/index.html", "templates/404.html", "templates/400.html", "templates/500.html")
	if err != nil {
